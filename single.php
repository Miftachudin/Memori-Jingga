...
<div class="meta-post">
	<?php _e( 'Category : ', 'memorijingga' ); ?> <?php the_category(', '); ?>
	<?php _e( 'Tags :', 'memorijingga' ); ?> <?php the_tags('', ', '); ?>
</div>

<?php endwhile; else: ?>
<?php _e('Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'blank'); ?>
<?php endif; ?>
